...
export default function AboutUs() {
  return (
    <div className="w-full relative flex flex-col gap-6 py-8">
      <WhatWeDo></WhatWeDo>
      <div className="flex justify-between w-full gap-24 px-4 lg:px-10">
        ...
        >
          <motion.div
            ...
            className="absolute bg-gradient-to-b from-color-2 via-color-2 to-transparent h-full w-full  rounded-lg "
          ></motion.div>
          <Image
