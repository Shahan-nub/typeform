...
export default function FeaturesCard({ title, src, id }) {
  return (
    <div className="flex  flex-col group gap-4 lg:gap-7 rounded-md my-4 lg:my-auto bg-glass lg:bg-transparent lg:hover:bg-glass transition-all duration-500 py-5 lg:py-9 px-4 lg:px-10 text-gray-400">
      ...
      <hr />
      <div className="relative cursor-pointer flex gap-4 lg:gap-0 items-center">
