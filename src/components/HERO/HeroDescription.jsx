...
export default function HeroDescription() {
  return (
    <div className="flex flex-col gap-9 lg:flex-row w-full py-6 px-6 md:py-6 md:px-12 font-light relative mb-10 md:mb-24">
      ...
      <div className="bg-gradient-to-b from-glass via-[#1f2131] to-glass rounded-sm flex flex-col gap-5 items-center py-4 md:py-6 px-5 md:px-7">
        ...
        <p className="text-gray-400 text-center text-base md:text-lg ">
          Templates for various e-commerce & portfolio websites.
        </p>
      ...
      <div className="bg-gradient-to-b from-glass via-[#1f2131] to-glass rounded-sm flex flex-col justify-between items-center py-4 md:py-6 px-5 md:px-7 text-center">
            <Logo></Logo>
