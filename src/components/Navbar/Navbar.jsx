  ...
  return (
    <div className="text-white px-2 md:px-4 py-4 md:py-8">
      <div className="flex md:justify-between justify-center gap-8 md:gap-0 items-center">
        ...
        {/* Explore our demos */}
        <Link href="/#work" className="hidden md:inline-block mr-3 lg:mr-8  text-base md:text-lg bg-[#4c5cf0] rounded-lg py-2 md:py-3 px-2 md:px-4 cursor-pointer max-h-max">
          Explore our demos
        </Link>
      </div>
    </div>
