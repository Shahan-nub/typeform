...
export default function AIServiceCard({ src, date, title, alt }) {
  return (
    ...
    viewport={{once:true}}
    className="group flex flex-col py-8 px-6 bg-gradient-to-r from-glass via-[#171c33] to-glass hover:shadow-[0_-1px_0_0_#4c5cf0] text-left gap-3 lg:gap-6 w-max lg:basis-[30%] flex-1 lg:flex-none rounded-sm transition-shadow duration-500">
